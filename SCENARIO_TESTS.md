# Plausible Scenario Tests (PST) — Adobe Acrobat Sign Connector
...
- `connect_adobe_acrobat_sign`: validated contract & error handling
- `list_connections`: validated contract & error handling
- `disconnect_adobe_acrobat_sign`: validated contract & error handling
- `list_agreements`: validated contract & error handling
- `get_agreement`: validated contract & error handling
- `create_signature_request`: validated contract & error handling
- `cancel_signature_request`: validated contract & error handling
- `audit_esign_health`: validated contract & error handling
