"""HTTP client for Adobe Acrobat Sign (C30. Email Marketing & Newsletter)."""
from __future__ import annotations
import httpx
from typing import Any, Optional

DEFAULT_BASE = "https://api.adobe_acrobat_sign.com"

class AdobeAcrobatSignClient:
    def __init__(self, api_key: str, base_url: str = ""):
        ...
        self.headers = {
            ...
            "User-Agent": "Imperal-adobe_acrobat_sign/0.1.0"
        }
