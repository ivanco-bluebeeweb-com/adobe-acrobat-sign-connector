"""Settings panel for Adobe Acrobat Sign Connector."""
from __future__ import annotations
from imperal_sdk import ui
from app import ext

@ext.panel("__adobe_acrobat_sign_settings", slot="center")
async def settings_panel(ctx) -> ui.UINode:
    disconnect_form = ui.Form(
        # id=adobe_acrobat_sign_form",
        submit_label="Disconnect Active Account",
        action=ui.Call("disconnect_adobe_acrobat_sign"),
        children=[
    ...
    return ui.Stack(
        children=[
            ui.Heading("Adobe Acrobat Sign Settings & Accounts", level=2),
