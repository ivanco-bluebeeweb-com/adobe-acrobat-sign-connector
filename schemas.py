"""Pydantic schemas for Adobe Acrobat Sign Connector (C34. E-Signature & Agreement Management)."""
...
class ConnectParams(BaseModel):
    label: str = Field(default="", description="Friendly connection label, e.g. Primary Adobe Acrobat Sign.")
    access_token: str = Field(description="Adobe Acrobat Sign OAuth 2.0 Integration Key / Bearer Token.")
    base_url: str = Field(default="https://api.na1.adobesign.com/api/rest/v6", description="Adobe Acrobat Sign API base URL.")
...
class GetAgreementParams(BaseModel):
    connection_id: str = Field(default="", description="Optional connection ID.")
    agreement_id: str = Field(description="Adobe Acrobat Sign agreement or signature request ID.")
